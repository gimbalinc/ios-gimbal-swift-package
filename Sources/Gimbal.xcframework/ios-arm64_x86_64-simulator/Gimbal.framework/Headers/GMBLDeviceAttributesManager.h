 ...
 */
- (BOOL)setDeviceAttributes:(nullable NSDictionary *)attributes DEPRECATED_MSG_ATTRIBUTE("use setDeviceAttribute instead.");
 ...
 *
 * @param key The new desired key to remove value from
 */
 ...
 *
 * @param key The new desired key to return value from
 */
